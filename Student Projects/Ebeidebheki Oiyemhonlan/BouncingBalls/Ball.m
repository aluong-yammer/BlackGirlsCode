...
//
//
// Ebeidebheki Oiyemhonlan cutie10033@gmail.com
...
- (void)layoutSubviews
{
    ...
    self.ball.image = [UIImage imageNamed:@"ebei"];
...
{
    self.ball.image = [UIImage imageNamed:@"bugs"];
    
    NSString *soundPath = [[NSBundle mainBundle]
                           pathForResource:@"cartoon_hop" ofType:@"mp3"];
